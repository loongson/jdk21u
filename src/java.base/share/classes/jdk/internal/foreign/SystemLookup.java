...
public final class SystemLookup implements SymbolLookup {
    ...
    private static SymbolLookup makeSystemLookup() {
        try {
            return switch (CABI.current()) {
                case SYS_V, LINUX_AARCH_64, MAC_OS_AARCH_64, LINUX_RISCV_64, LINUX_LOONGARCH_64 -> libLookup(libs -> libs.load(jdkLibraryPath("syslookup")));
    ...
    private static Path jdkLibraryPath(String name) {
        ...
        String lib = switch (CABI.current()) {
            case SYS_V, LINUX_AARCH_64, MAC_OS_AARCH_64, LINUX_RISCV_64, LINUX_LOONGARCH_64 -> "lib";
