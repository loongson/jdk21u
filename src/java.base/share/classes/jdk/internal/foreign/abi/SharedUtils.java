...
public final class SharedUtils {
    ...
    public static VaList newVaList(Consumer<VaList.Builder> actions, SegmentScope session) {
        return switch (CABI.current()) {
            ...
            case LINUX_LOONGARCH_64 -> LinuxLoongArch64Linker.newVaList(actions, session);
        };
    }
    ...
    public static VaList newVaListOfAddress(long address, SegmentScope session) {
        return switch (CABI.current()) {
            ...
            case LINUX_LOONGARCH_64 -> LinuxLoongArch64Linker.newVaListOfAddress(address, session);
        };
    }
    ...
    public static VaList emptyVaList() {
        return switch (CABI.current()) {
            ...
            case LINUX_LOONGARCH_64 -> LinuxLoongArch64Linker.emptyVaList();
        };
    }
